...
def main():
    ...
    for i in np.arange(nc):
        ...
        for j in np.arange(nv):
            ...
            if l_ens:
                plot_pfl_cmp_turbmethods_ens(turbmethod_list, case, var, c_max, c_min, d_max, depth)
            else:
...
def plot_pfl_cmp_turbmethods_ens(turbmethod_list, case, var, c_max, c_min, d_max, depth):
